...
local taglist_panel = require("layout.taglist-panel")
local workspace = require("layout.workspace")
...
modkey = "Mod4"
naughty.config.defaults.bg = theme.colors.background
naughty.config.defaults.icon_size = dpi(64)
naughty.config.defaults.width = dpi(320)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create Panels
    s.mytasklist = tasklist_panel(s, true)
    s.clock_panel = clock_panel(s, true)
    s.mytaglist = taglist_panel(s, true)

    gears.wallpaper.maximized("/home/james/Downloads/wallpaper.jpg", s)
...
awful.rules.rules = {
    ...
    -- Set Minecraft to always to the Game Tag
    { rule = { class = "Minecraft" },
    properties = { screen=1, tag = ""} },

    { rule = { class = "Spotify" },
    properties = { screen=2, tag = "", fullscreen=true} },
}
-- }}}
